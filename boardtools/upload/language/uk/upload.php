...
$lang = array_merge($lang, array(
	...
	'ACP_UPLOAD_EXT_DESCRIPTION'		=> 'Встановлюйте/оновлюйте/видаляйте розширення, керуйте їхніми ZIP-файлами та виконуйте інші завдання - все це без використання FTP.',
	'ACP_UPLOAD_EXT_TITLE_EXPLAIN'		=> 'Завантаження Розширень дає змогу вам завантажувати ZIP-файли розширень або видаляти папки розширень із сервера. <br />Маючи це розширення, ви можете встановлювати/оновлювати/видаляти розширення без використання FTP. Якщо завантажене вами розширення вже існує, його файли будуть замінені на завантажені вами.',
	'ACP_UPLOAD_EXT_HELP'				=> 'Завантаження Розширень: Керівництво користувача',
	'UPLOAD'							=> 'Завантажити',
	'BROWSE'							=> 'Огляд...',
	'EXTENSION_UPLOAD'					=> 'Завантажити розширення',
	'EXTENSION_UPLOAD_EXPLAIN'			=> 'Тут ви можете завантажити зі свого комп\'ютера або з віддаленого сервера ZIP-файл розширення, що містить необхідні файли для встановлення. "Завантаження Розширень" спробує розпакувати архів і підготувати його для встановлення.<br />Виберіть файл або вкажіть посилання на джерело в полях внизу.',
	'EXT_UPLOAD_ERROR'					=> 'Розширення не було завантажено.',
	'EXT_UPLOAD_INIT_FAIL'				=> 'У процесі ініціалізації завантаження розширення виникла помилка.',
	'EXT_NOT_WRITABLE'					=> array(
		'error'		=> 'Відсутні права на запис для папки ext/. Ці права необхідні для правильного завантаження розширень.',
		'solution'	=> 'Будь ласка, виправте права доступу або налаштування і спробуйте знову.',
	),
