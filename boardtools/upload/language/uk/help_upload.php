...
$help = array(
	...
	array(
		0 => 'Що дає функція "Завантажити розширення"?',
		1 => 'Ви можете завантажувати розширення з різних джерел без необхідності використовувати FTP-клієнт. Коли ви завантажуєте розширення, яке вже є на вашій конференції, його застарілу версію буде автоматично збережено в обраній директорії на вашій конференції - перейдіть у модуль "Управління ZIP-файлами". Ви також можете зберегти ZIP-файл поточної завантажуваної версії розширення - встановіть прапорець "Зберегти завантажений ZIP-файл" до початку процесу завантаження. Щоб бути впевненими в тому, що ви завантажуєте правильний ZIP-файл розширення, вкажіть його контрольну суму у відповідному полі форми.'
	),
	array(
		0 => 'У чому різниця між "Модулем управління розширеннями, вбудованим у Завантаження Розширень" і стандартним модулем "Управління розширеннями"?',
		1 => 'Як і стандартний модуль "Керування розширеннями", "Модуль керування розширеннями, вбудований у Завантаження Розширень" - це інструмент вашої конференції phpBB, що дає змогу вам керувати всіма вашими розширеннями та переглядати інформацію про них. Але цей інструмент можна назвати "поліпшеною версією" стандартного модуля.<br /><br /><strong>Ключові переваги:</strong><ul><li>Усі завантажені розширення сортуються в алфавітному порядку, незалежно від того, які вони: увімкнені, вимкнені або деінстальовані. Виняток: несправні розширення.</li><li>Несправні розширення показуються окремо на тій же сторінці "Модуля управління розширеннями" нижче списку звичайних розширень. Причини недоступності показуються для кожного несправного розширення. Докладний текст попередження додається до цих причин, якщо несправне розширення встановлено на конференції або якщо будь-які дані про нього збережено в базі даних. Ви можете натиснути на рядок будь-якого несправного розширення, щоб побачити детальну інформацію про нього, так само, як можна робити для справних розширень.</li><li>Будь-яке розширення (якщо воно справне) можна ввімкнути одним кліком на перемикачі, який розміщено ліворуч від імені розширення в списку.</li></ul>'
	),
	array(
