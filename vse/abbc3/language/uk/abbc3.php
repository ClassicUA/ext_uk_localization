...
$lang = array_merge($lang, array(
	...
	'ABBC3_PIPE_TABLES_EXPLAIN'	=> 'Створюйте таблиці, використовуючи будь-який з цих форматів у стилі ASCII.',
	'ABBC3_PIPE_DOCUMENTATION'	=> 'Посібник користувача',
	'ABBC3_PIPE_SIMPLE'			=> 'Проста таблиця',
	'ABBC3_PIPE_COMPACT'		=> 'Компактна таблиця',
	...
	'ABBC3_PIPES'				=> 'Увімкніть плагін Pipe Table',
	'ABBC3_PIPES_EXPLAIN'		=> 'Плагін Pipes Table дозволяє користувачам створювати таблиці у своїх дописах і приватних повідомленнях, використовуючи синтаксис розмітки.',
	'ABBC3_BBCODE_BAR'			=> 'Увімкнути панель іконок BBCode',
	'ABBC3_BBCODE_BAR_EXPLAIN'	=> 'Буде показано панель інструментів BBCode на основі іконок ABBC3. Вимкніть цей параметр, щоб відображати кнопки BBCode за замовчуванням phpBB.',
	'ABBC3_QR_BBCODES'			=> 'Ввімкнути BBCodes у швидкій відповіді',
	'ABBC3_QR_BBCODES_EXPLAIN'	=> 'Це додасть кнопки BBCode до швидкої відповіді.',
	'ABBC3_ICONS_TYPE'			=> 'Формат зображення панелі іконок',
	'ABBC3_ICONS_TYPE_EXPLAIN'	=> 'Виберіть формат зображення для іконок ABBC3. Зверніть увагу, що ви можете вибрати лише один формат для всіх ваших іконок.',
